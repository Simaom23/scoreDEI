...
public class PlayerController {
    ...
    @GetMapping("/statsPlayersUnsigned")
    public String statsPlayersUnsigned(@RequestParam(name = "order", required = false) String order, Model model) {
        if (order == null)
            order = "AscendingPlayers";
